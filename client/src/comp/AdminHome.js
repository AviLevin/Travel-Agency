...
class AdminHome extends Component {
  ...
  render() {
    return (
      <div className="admin-home-comp">
        {/* delete vacation -modal______________________________ */}
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                <div>
                  ...
                  <h4 className="modal-title">
                    {this.state.vacationDestination}
                  </h4>
                </div>
              ...
              <div className="modal-body">
                ...
                <div className="row-warrnig">
                  <label className="fas fa-exclamation-triangle"></label>This
                  vacation has {this.state.vacationFollowers} followers!
                </div>
              </div>
              <div className="modal-footer">
                <button
                  type="button"
                  onClick={this.deleteVacation.bind(
                    this,
                ...
                <button
                  type="button"
                  onClick={this.restartState.bind(this)}
        ...
        {/* edit-modal ______________________________*/}
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="row">
                  ...
                  <div className="col">
                    <input
                      type="text"
                      name="newVacationDestination"
                      onChange={this.handleText.bind(this)}
                      value={this.state.newVacationDestination}
                    ></input>
                  </div>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col">
                    <textarea
                      ...
                      onChange={this.handleText.bind(this)}
                      value={this.state.vacationDescription}
                    ></textarea>
                  </div>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col">
                    <input
                      ...
                      onChange={this.handleText.bind(this)}
                      value={this.state.vacationFromDate}
                    ></input>
                  </div>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col">
                    <input
                      ...
                      name="vacationPrice"
                      onChange={this.handleText.bind(this)}
                      value={this.state.vacationPrice}
                    ></input>
                  </div>
                </div>
              </div>
              ...
              <div className="modal-footer">
                ...
                <button
                  type="button"
                  onClick={this.sendVacation.bind(this)}
                  className="btn btn-success"
                >
                  Edit
                </button>
                ...
                <div key={v.id} className="card" style={{ width: "18rem" }}>
                  <div>
                    <button
                      ...
                      className="fas fa-edit edit-icon btn btn-light"
                      data-toggle="modal"
                    ...
                    <button
                      ...
                      className="fas fa-trash-alt btn btn-light"
                      data-toggle="modal"
                  ...
                  <div className="card-body">
                    ...
                    <ul className="list-group list-group-flush">
                      <li className="list-group-item">
                        <p>
                          <label className="fas fa-plane-departure plane-icon"></label>
                          {v.from_date}
                        </p>
                        <p>
                          <label className="fas fa-plane-arrival plane-icon"></label>
                          {v.end_date}
                        </p>
                      </li>
                      <li className="list-group-item">
                        {v.price}
                        <label className="fas fa-dollar-sign dollar-icon"></label>
                      </li>
                      <li className="list-group-item">
                        <label className="fas fa-eye eye-icon">
                          {v.followers}
                        </label>
                      </li>
                    </ul>
    ...
    if (ev.target.name == "newVacationImgs") {
      ...
      if (file) {
        if (file.type == "image/jpeg") {
          ...
          this.setState({
            typeFile: "error",
            newVacationImgs: "error",
            msg: "Upload only a jpeg image file!"
          });
        }
      } else {
  ...
  sendVacation() {
    if (
      this.state.newVacationDestination == "" ||
      this.state.vacationDescription == "" ||
      this.state.newVacationImgs == "" ||
      this.state.vacationFromDate == "" ||
      this.state.vacationEndDate == "" ||
      this.state.vacationPrice == ""
    ) {
