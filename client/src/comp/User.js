      ...
      <div className="user-comp">
        <div className="row">
          ...
          <div className="col-6 col-header">
            <button className="btn btn-info" onClick={this.logout.bind(this)}>
              Logout
            </button>
          </div>
        </div>
                    ...
                    <ul className="list-group list-group-flush">
                      ...
                      <li className="list-group-item">
                        <input
                          ...
                          onChange={this.changeFollow.bind(this, v.id)}
                          type="checkbox"
                        />
...
let mapStateToProps = function(state) {
  return {
    ...
    vacationsOnFoolow: state.vacationsOnFoolow,
    vacationsOffFoolow: state.vacationsOffFoolow
  };
};
